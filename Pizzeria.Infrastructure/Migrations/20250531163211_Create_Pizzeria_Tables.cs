...
{
    /// <inheritdoc />
    public partial class Create_Pizzeria_Tables : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    BonustPoints = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductsItemId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_IngredientItem", x => new { x.IngredientsIngredientId, x.ProductsItemId });
                    table.ForeignKey(
                        name: "FK_IngredientItem_Ingredients_IngredientsIngredientId",
